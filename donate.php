...
if ( isset( $_POST[ 'submit' ] ) ) {
    ...
    if ( isset( $_POST[ 'term' ] ) === true ) {
        ...
        <strong>Only lower & upper case character allow.</strong>
       ...
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
            ...
            $cityError = ' <div class="alert alert-success alert-dismissible fade show" role="alert">
      <strong>Please enter the city.</strong>
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>';
       ...
       <strong>The Password not same.</strong>
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>';
            ...
            $passwordError = ' <div class="alert alert-success alert-dismissible fade show" role="alert">
       <strong>The Password should be 6 char.</strong>
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>';
...
<optgroup
title = 'Azad Jammu and Kashmir (Azad Kashmir)'
label = '&raquo; Azad Jammu and Kashmir (Azad Kashmir)'
></optgroup>
...
label = '&raquo; Federally Administered Tribal Areas (FATA'
></optgroup>
...
<option value = 'North Waziristan Agency'>
North Waziristan Agency
</option>
<option value = 'Orakzai Agency'>Orakzai Agency</option>
<option value = 'South Waziristan Agency'>
South Waziristan Agency
</option>
<optgroup
title = 'Islamabad Capital'
label = '&raquo; Islamabad Capital'
></optgroup>
<option value = 'Islamabad'>Islamabad</option>
<optgroup
title = 'North-West Frontier Province (NWFP)'
label = '&raquo; North-West Frontier Province (NWFP)'
></optgroup>
...
><b
>I am agree to donate my blood and show my Name, Contact Nos. and
E-Mail in Blood donors List</b
></span
>
</div>
<!--End form-group-->
